"""Hexagon packing grader (N=12).

Evaluates programs that pack 12 unit regular hexagons inside a larger regular
...
outer_hex_side_length) where:
  - inner_hex_data: numpy array of shape (12, 3), each row (x, y, angle_degrees)
...
N_HEX = 12
BENCHMARK = 1 / 3.9419123  # ~0.2537


class Grader(TaskGrader):
    """Grader for the hexagon packing problem (N=12).
