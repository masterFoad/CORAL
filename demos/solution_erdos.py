            1.8364261507638082e-11,
            1.6738456720179691e-11,
            1.4893963302234699e-11,
            1.3741203818080857e-11,
            1.2970357317527860e-11,
            1.2867010021491741e-11,
            1.2412583462299774e-11,
            1.1779546610009546e-11,
            1.1549025288784849e-11,
            1.1382693370524769e-11,
            1.1120957508016490e-11,
            1.0745887624315151e-11,
            1.0596457234502239e-11,
            1.0255427198235500e-11,
            1.0114751711928306e-11,
            9.8279589447487839e-12,
            9.5963890887893560e-12,
            9.4521971106009920e-12,
            9.1087894580250709e-12,
            9.0434486635064529e-12,
            8.5931472882588147e-12,
            8.0511447162337174e-12,
            7.9128617327324150e-12,
            7.5640425894848365e-12,
            7.3363842316537212e-12,
            7.0105973951265194e-12,
            6.7355770824145596e-12,
            6.5212706120363056e-12,
            6.2952655342030531e-12,
        ]
    )
    if N == 600:
        ...
        try:
            ...
            if result.success:
                ...
                if return_dual and hasattr(result, "ineqlin") and result.ineqlin is not None:
                    last_dual = (
                        result.ineqlin.marginals if hasattr(result.ineqlin, "marginals") else None
                    )
...
def optimize_pgd(
    h_init, N, lr=0.002, num_steps=15000, temp_start=30.0, temp_end=200.0, time_limit=None
):
...
def optimize_coordinate_descent(h_init, N, max_passes=200, time_limit=None):
    ...
    for pass_num in range(max_passes):
        ...
        for idx in range(half_N):
            ...
            max_per_candidate = np.max(
                corr[np.newaxis, :] + deltas[:, np.newaxis] * grad_k[np.newaxis, :], axis=1
            )
            ...
            fine = np.linspace(max(0, best_val - 0.05), min(1, best_val + 0.05), 11)
            deltas_f = fine - old_val
            max_fine = np.max(
                corr[np.newaxis, :] + deltas_f[:, np.newaxis] * grad_k[np.newaxis, :], axis=1
            )
...
def optimize_subspace(h_init, N, n_modes=25, time_limit=60):
    ...
    result = sp_minimize(
        ...
        x0,
        method="Nelder-Mead",
        options={"maxiter": 3000, "maxfev": 5000, "xatol": 1e-6, "fatol": 1e-10, "adaptive": True},
    )
    ...
    if time_limit and time.time() - t_start < time_limit * 0.6:
        result2 = sp_minimize(
            ...
            nm_best,
            method="Powell",
            options={"maxiter": 2000, "maxfev": 4000, "ftol": 1e-11},
        )
...
def optimize_de_parametric(h_init, N, n_steps=30, time_limit=60, rng=None):
    ...
    x0_heights = np.array([np.mean(h_half_init[bin_assignments == s]) for s in range(n_steps)])
    ...
    try:
        result = de(
            ...
            popsize=15,
            tol=1e-10,
            seed=int(rng.integers(10000)) if rng else 42,
            init="latinhypercube",
            mutation=(0.5, 1.5),
            recombination=0.9,
            polish=False,
...
def run():
    ...
    if remaining() > 10:
        h_nm, c5_nm = optimize_nelder_mead_subspace(
            h_best, N, n_modes=20, max_restarts=10, time_limit=min(remaining() - 5, 40)
        )
    ...
    if remaining() > 10:
        h_nm2, c5_nm2 = optimize_nelder_mead_subspace(
            h_best, N, n_modes=40, max_restarts=10, time_limit=min(remaining() - 5, 60)
        )
    ...
    if remaining() > 10:
        h_nm3, c5_nm3 = optimize_nelder_mead_subspace(
            h_best, N, n_modes=60, max_restarts=8, time_limit=min(remaining() - 5, 60)
        )
    ...
    if remaining() > 5:
        h_cd, c5_cd = optimize_coordinate_descent_full(
            h_best, N, max_passes=3, time_limit=min(remaining() - 3, 15)
        )
